...
object SocialConstants {
    // CHANNEL NAME
    const val CHANNEL_NAME = "social_sharing_plus"

    // METHOD NAMES
    const val FACEBOOK = "shareToFacebook"
    const val TWITTER = "shareToTwitter"
    const val LINKEDIN = "shareToLinkedIn"
    ...
    const val TWITTER_WEB_URL = "https://twitter.com/intent/tweet?text="
    const val LINKEDIN_WEB_URL = "https://www.linkedin.com/sharing/share-offsite/?url="
